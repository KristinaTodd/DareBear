  ...
  <div class="main-font">
    ...
    <div class="row">
      <div class="col-xs-12 mx-4">
        <h5 class="text-warning">Do Not Start the game until all players have joined. (You'll miss out on really cool
          dares)</h5>
        <div class="info-border">
          <div class="row">
            <div class="col-12">
              <p class="text-info">Who's in...</p>
              <p class="text-white">NOTE Need to generate player icons and usernames vertically for each player in store
                player array...</p>
            </div>
          </div>
        </div>
